...
const initialCategories: CategoryData[] = [
  {
    ...
    image: 'https://res.cloudinary.com/dxs9msbqj/image/upload/v1751044963/WhatsApp_Image_2025-06-27_at_3.45.16_PM_lmwqtw.jpg',
    icon: 'Palette',
    featured: true,
  ...
  },
  {
    ...
    image: 'https://res.cloudinary.com/dxs9msbqj/image/upload/v1750791409/pexels-ivan-samkov-5799059_pfgzxs.jpg',
    icon: 'Leaf',
    featured: true,
  ...
  },
  {
    ...
    image: 'https://res.cloudinary.com/dxs9msbqj/image/upload/v1750791404/shutterstock_2298085401_lrfuto.webp',
    icon: 'Building',
    featured: true,
  ...
  },
  {
    ...
    image: 'https://res.cloudinary.com/dxs9msbqj/image/upload/v1750791403/Polyurethane_cz4odx.webp',
    icon: 'Wrench',
    featured: true,
